"""Failure and success branches for adaptive negotiation runs."""
...
from cop_worker.protocol.conformance import ConformanceReport, ProbeOutcome
...
from tests.helpers_codex_pipeline_gmail import (
    _conforming_probe,
    _intro,
    _patch_transport,
    _probe,
...
async def test_negotiation_rejects_static_and_conformance_failures(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr(
        "cop_worker.protocol.pipeline.ConformanceProbes.run_all", lambda _self: failed
    )

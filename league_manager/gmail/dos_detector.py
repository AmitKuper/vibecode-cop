...
from cop_worker.gmail.dos_detector import *  # noqa: F401,F403
from cop_worker.gmail.dos_detector import __name__ as _canonical_name  # noqa: F401

sys.modules[__name__] = sys.modules["cop_worker.gmail.dos_detector"]

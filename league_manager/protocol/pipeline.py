...
from league_manager.protocol.adapter import DeterministicProtocolAdapter, ProtocolCompatibilityError
from league_manager.protocol.conformance import ConformanceProbes
from league_manager.protocol.introspector import MCPIntrospector
from league_manager.protocol.mapping_plan import ProtocolMappingPlan
from league_manager.protocol.profile import ProfileCache, ProtocolProfile
from league_manager.protocol.protocol_agent import ProtocolUnderstandingAgent
from league_manager.protocol.reference_v3 import (
    ReferenceV3Profile,
    ReferenceV3Session,
    assert_core_vectors,
)
from league_manager.protocol.transport_probe import TransportProbe, TransportType
...
async def verify_locked_schema(profile: ProtocolProfile, timeout_s: float = 10.0) -> None:
    ...
    from league_manager.protocol.transport_probe import ProbeResult

...
from cop_worker.protocol.verifier import *  # noqa: F401,F403
from cop_worker.protocol.verifier import __name__ as _canonical_name  # noqa: F401

sys.modules[__name__] = sys.modules["cop_worker.protocol.verifier"]

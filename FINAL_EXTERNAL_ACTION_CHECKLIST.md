...
Evidence date: 2026-08-05. Every row requires genuine real-world evidence. None
may be satisfied by localhost, fixtures, fake Gmail, generated IDs, placeholder
screenshots, or an unpushed local tag.

| Rule(s) | Required action and acceptable evidence | Status |
|---|---|---|

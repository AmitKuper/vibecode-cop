"""One interactive gamelet of the human-vs-rl CLI."""
...
from human_play.rl_board import _legal_moves_for, _render_board
from human_play.rl_moves import _get_agent_move, _get_human_move
...
def _run_gamelet(
    ...
    while True:
        ...
        print("═" * 60)
        print(
            f"  COP vs THIEF — Human ({human_role.upper()}) vs RL champion ({agent_role.upper()})"
        )
        print("  [informal test tool — pure RL inference, no LLM]")

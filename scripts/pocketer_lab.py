...
adaptive pocketing, the line-partition hunt, and the cage-cork (classes in
scripts/pocketer_cops.py). Each runs against the old cut-blind thief and
the current production thief.
...
from pocketer_cops import HUNTERS, N
...
from cop_worker.rl.sealability import ORTHO

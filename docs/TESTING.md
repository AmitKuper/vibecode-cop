...
Status: current as of 2026-08-23. Companion evidence document:
...
last measured **97.38%** (2026-08-24, 1,985 passed; see `docs/TEST_EVIDENCE.md`); the gate is raised only

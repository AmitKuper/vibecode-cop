...
Also provides ReplayViewer for lightweight log-JSON step navigation.
"""
...
from cop_worker.mcp.crypto import (
...
class ReplayViewer:
    ...
    def __init__(self, log_path: str | Path) -> None:
        ...
        if not isinstance(data, dict):
            raise ReplayError(f"{log_path} must contain a JSON object")
        self._data = data

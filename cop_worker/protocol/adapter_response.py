"""Response adaptation of the deterministic protocol adapter (mixin)."""
...
from cop_worker.protocol.mapping_plan import PhaseMapping, ProtocolMappingPlan

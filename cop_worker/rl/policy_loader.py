...
def load_checkpoint(path: Path, role: str, max_steps: int) -> RLPolicy:  # noqa: F821
    ...
    from cop_worker.rl.policy import RLPolicy  # local import avoids circular dependency
    ...
    from cop_worker.rl.observation import observation_shape as _obs_shape

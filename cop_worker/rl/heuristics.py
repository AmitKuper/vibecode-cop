...
from cop_worker.rl.action_space import COP_ACTIONS, MOVE_DELTAS, THIEF_ACTIONS
...
def random_legal_cop(
    ...
    from cop_worker.rl.action_space import compute_legal_mask_cop
...
def random_legal_thief(
    ...
    from cop_worker.rl.action_space import compute_legal_mask_thief
